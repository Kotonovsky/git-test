...
// Задача 8*) Даны два целых числа: A, B. Проверить истинность высказывания: «Ровно одно из чисел A и B нечетное».
    ...
    if ((a % 2 != 0) && (b % 2 != 0)){
        alert ( false );                        //Вывожу false если оба параметра верны
    } else {
        alert ((a % 2 != 0) || (b % 2 != 0));   //Выводит true если один из параметров true
    }
